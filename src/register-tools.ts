...
export const SERVER_INSTRUCTIONS = [
  ...
  "",
  "FONTOS - Hatekonysag:",
  "- Ha tobb projekt teendoire vagy kivancsi, MINDIG hasznald a minicrm_list_all_todos-t (egy hivas az osszes projektbol).",
  "- Ha egy felhasznalo napi teendoire vagy kivancsi, hasznald a minicrm_my_day-t.",
  "- NE hivd meg egyenkent a minicrm_list_todos-t minden projektre! Az aggregalo toolok 10x gyorsabbak.",
  "",
  "Munkafolyamat:",
