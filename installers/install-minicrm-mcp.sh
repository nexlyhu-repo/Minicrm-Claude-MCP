#!/bin/bash
# MiniCRM MCP Telepito - Linux
# Futtatas: chmod +x install-minicrm-mcp.sh && ./install-minicrm-mcp.sh

clear
echo ""
echo "╔══════════════════════════════════════════╗"
echo "║   MiniCRM MCP - Telepito (Linux)         ║"
...
if ! command -v node &> /dev/null; then
    ...
    echo "Vagy: sudo apt install nodejs npm"
